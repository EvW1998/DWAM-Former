...
_C.model.type = 'DWAM-Former'   # Transformer, DWAM-Former
...
_C.dataset.database = 'daic_woz'   # daic_woz
# Select a kind of feature to train a model
_C.dataset.feature = 'hubert24'    # spec, logmel, fbank, wav2vec, w2v12, w2v24, hubert12, hubert24
